    ...
    <div class="card shadow">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('booking-seats.edit', $bookingSeat->id) }}" class="btn btn-outline-primary">
        ...
        <div class="card-body">
            ...
            <div class="mt-4">
                <div class="d-flex gap-2">
                    <a href="{{ route('booking-seats.edit', $bookingSeat->id) }}" class="btn btn-primary">
                    ...
                    @if($bookingSeat->status != 'cancelled')
                        <form action="{{ route('booking-seats.destroy', $bookingSeat->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to cancel this seat?')">
