{{-- filepath: c:\xampp\htdocs\aurora_cinema\resources\views\auth\register.blade.php --}}
@extends('layouts.app')
    ...
    <div class="auth-modal-card p-4 p-md-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="btn-group w-100" role="group">
                <a href="{{ route('register') }}" class="btn btn-dark active rounded-pill me-2" style="flex:1;">Sign up</a>
                <a href="{{ route('login') }}" class="btn btn-dark rounded-pill" style="flex:1;">Sign in</a>
            </div>
            <a href="{{ url('/') }}" class="btn-close ms-3" aria-label="Close"></a>
        </div>
        <h4 class="fw-bold mb-4 text-white">Create an account</h4>
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col">
                    <input id="lastname" type="text" class="form-control glass-input"
                        name="lastname" value="{{ old('lastname') }}" autocomplete="family-name" placeholder="Last name">
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input id="phone" type="tel" class="form-control glass-input"
                    name="phone" value="{{ old('phone') }}" autocomplete="tel" placeholder="Phone (optional)">
            </div>
            <div class="mb-3">
            ...
            <div class="text-center text-secondary mb-3">OR SIGN IN WITH</div>
            <div class="d-flex gap-2 mb-3">
                <a href="#" class="btn btn-dark w-100 rounded-pill d-flex align-items-center justify-content-center gap-2">
            ...
            <div class="text-center mt-3 text-secondary" style="font-size: 0.9rem;">
                By creating an account, you agree to our <a href="#" class="text-white text-decoration-underline">Terms & Service</a>
            </div>
        </form>
    </div>
</div>
