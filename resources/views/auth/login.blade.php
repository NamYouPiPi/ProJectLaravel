            ...
            <div class="card shadow border-0 rounded-3">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                            <div class="position-relative">
                                <div>
                                    <span
                                        style="position: absolute; top: -10px; left: 0;  padding: 0 5px; color: #a880e9; font-size: 14px;">
                                        {{ __('Email') }}
                                    </span>
                                </div>
                                <input id="email" type="Email"
                                    class="form-control text-dark form-control-lg @error('email') is-invalid @enderror border-0"
                        ...
                        <div class="mb-3">
                            <div class="position-relative">
                                ...
                                <input id="password" type="password"
                                    class="form-control text-dark form-control-lg @error('password') is-invalid @enderror border-0"
                        ...
                        <div class="mb-4 d-flex justify-content-between align-items-center">
                            ...
                            @if (Route::has('password.request'))
                                <a class="text-decoration-none" href="{{ route('password.request') }}" style="color: #a880e9;">
                                    {{ __('Forgot password?') }}
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="d-flex gap-2 mb-4">
                        ...
                        {{-- <a href="{{ route('login.twitter') }}" class="btn btn-outline-secondary" style="width: 50px;">
