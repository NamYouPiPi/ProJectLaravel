...
<table>
    ...
    @empty
    <tr>
        <td colspan="6" style="text-align: center; padding: 20px;">No sales data found for the selected period</td>
    </tr>
    @endforelse
    </tbody>
</table>
...
<div class="summary">
    ...
    <p><strong>Total Revenue (Top {{ $limit }}):</strong> ${{ number_format($bestSellers->sum('total_revenue'), 2) }}</p>
</div>
@endif
</body>
</html>
