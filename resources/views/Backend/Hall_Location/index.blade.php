...
<style>
    ...
    .btn_update_hall, .btn_del_hall, .location-details-btn {
    ...
    .btn_update_hall:hover, .btn_del_hall:hover, .location-details-btn:hover {
        ...
        <div class="row g-3">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="search" name="search"
                       value="{{ request('search') }}" placeholder="Search location name, address...">
            </div>
            <div class="col-md-2">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card location-card h-100">
                ...
                <div class="card-footer d-flex gap-2 justify-content-center">
                    <button class="btn btn-sm btn-outline-info location-details-btn" data-id="{{ $hall->id }}" title="View Details">
                        👁️ Details
                    </button>
                    ...
                    <x-delete-modal dataTable="hall_location" title="Delete Location">
                        <button type="button" class="btn btn-sm btn-danger btn_del_hall" data-id="{{ $hall->id}}"
                ...
                @foreach($hallocation as $hall)
                    <tr class="text-center">
                        ...
                        <td class="d-flex gap-1 ">
                            <button class="btn btn-sm btn-outline-info location-details-btn" data-id="{{ $hall->id }}">👁️</button>
                            <x-update-modal dataTable="hall_location" title="Edit Location">
                                <button type="button" class="btn btn-sm btn-success btn_update_hall" data-id="{{ $hall->id}}"
                                    data-bs-toggle="modal" data-bs-target="#updateModal">✏️</button>
                            </x-update-modal>
                            <x-delete-modal dataTable="hall_location" title="Delete Location">
                                <button type="button" class="btn btn-sm btn-danger btn_del_hall" data-id="{{ $hall->id}}"
                                    data-bs-toggle="modal" data-bs-target="#deletemodal">🗑️</button>
                            </x-delete-modal>
                        </td>
                    </tr>
                @endforeach
