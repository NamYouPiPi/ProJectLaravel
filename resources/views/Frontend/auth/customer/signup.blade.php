...
<section class="auth-container">
  <h1 class="page-title">  <a href="{{ route('fe.register') }}">Sign up</a>
</h1>


  <div class="card auth-card">
    <h3 class="h5 mb-3">Create your account</h3>
    ...
    <form method="POST"
          action="{{ \Illuminate\Support\Facades\Route::has('customer.register') ? route('customer.register') : url('/customer/register') }}">
      @csrf
    ...
    <div class="signup mt-4">
      ...
      <a href="{{ route('fe.login') }}">Sign in</a>
    </div>
  </div>
</section>
...
<style>
  ...
  .btn-warning{ background:#ffd54a; color:#111; border:none; }
