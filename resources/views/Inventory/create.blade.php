    ...
    <div class="card-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select" name="stock" aria-label="Please select status">
                    <option selected>Open this select menu</option>
                    <option value="in_stock">InStock</option>
                    <option value="out_of_stock">OutStock</option>
                </select>
            </div>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <label for="validationCustom02" class="form-label">Reorders Level <span
                        class="text-danger">*</span></label>
                <input type="number" class="form-control" id="validationCustom02" name="reorder_level" required />
            </div>
        </div>
