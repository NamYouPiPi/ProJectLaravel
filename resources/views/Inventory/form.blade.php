...
{{--            <select class="form-select" name="supplier_id" id="supplier_id"  aria-label="Please select status">--}}
...
{{--            </select>--}}
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="validationCustom02" name="stock" required value="{{old('contact_person',$suppliers->contact_person ?? "")}}" />
        </div>
    </div>
    ...
    <div class="row g-3">
        <!--begin::Col-->
        <div class="col-md-6">
            <label for="validationCustom01" class="form-label">Stock level <span class="text-danger">*</span></label>
            <input type="number" class="form-control" name="stock_level" id="validationCustom01" />
        </div>
        <div class="col-md-6">
            <label for="validationCustom02" class="form-label">Reorders Level <span class="text-danger">*</span></label>
